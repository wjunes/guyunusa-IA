# Glosario del dominio administracion-publica-estadisticas-uy

## A

**AGESIC (Agencia de Gobierno Electrónico y Sociedad de la Información y del Conocimiento)**: Organismo del Poder Ejecutivo responsable de la política de gobierno digital en Uruguay. Creada por la Ley 17.930/2005; depende de la Presidencia de la República.
...
**Carrera administrativa**: Sistema de normas que regula el ingreso, permanencia, ascenso y egreso de los funcionarios públicos presupuestados, basado en el principio de mérito.

**CBA**: Ver Canasta básica alimentaria.

**CEA-CEPAL (Conferencia Estadística de las Américas)**: Instancia de coordinación regional de los institutos nacionales de estadística de América Latina y el Caribe, bajo los auspicios de la CEPAL.

**CEPAL (Comisión Económica para América Latina y el Caribe)**: Organismo regional de la ONU para el análisis y la cooperación en desarrollo económico y estadística. Sede: Santiago de Chile.

**CLAD (Centro Latinoamericano de Administración para el Desarrollo)**: Organismo de cooperación técnica en materia de reforma y modernización del Estado en América Latina.

**COICOP (Clasificación del Consumo Individual por Finalidades)**: Clasificación estadística internacional utilizada para estructurar la canasta del IPC y las encuestas de gasto de hogares.
...
**ECH (Encuesta Continua de Hogares)**: Encuesta permanente del INE, continua desde 1968, que mide empleo, ingresos, pobreza y condiciones de vida de los hogares uruguayos.

**Ente autónomo**: Persona jurídica estatal con autonomía funcional y técnica, sujeta a tutela del Poder Ejecutivo. Ejemplos: UdelaR, ANEP, BPS, BCU, BSE.

**Escalafón**: Sistema de clasificación de los cargos públicos según la naturaleza de las tareas (Administrativo, Técnico, Profesional, Servicio, etc.).
...
**IDDHH (Institución Nacional de Derechos Humanos y Defensoría del Pueblo)**: Organismo independiente de defensa de los derechos humanos en Uruguay; no confundir con la UAIP.

**IDH (Índice de Desarrollo Humano)**: Indicador compuesto elaborado por el PNUD que combina esperanza de vida, educación e ingreso.

**IMS (Índice Medio de Salarios)**: Indicador mensual del INE que mide la evolución de los salarios nominales y reales en Uruguay.

**INE (Instituto Nacional de Estadística)**: Organismo rector del Sistema Estadístico Nacional de Uruguay; creado por la Ley 16.616/1994.

**IPC (Índice de Precios al Consumo)**: Indicador mensual del INE que mide la variación de precios de la canasta de consumo de los hogares.
...
**OGP (Open Government Partnership / Alianza para el Gobierno Abierto)**: Iniciativa multilateral de gobierno abierto de la que Uruguay es miembro desde 2011.

**ONSC (Oficina Nacional del Servicio Civil)**: Organismo de la Presidencia de la República, rector del sistema de gestión humana del Estado uruguayo.
...
**SCN 2008 (Sistema de Cuentas Nacionales)**: Marco metodológico internacional para el cálculo del PIB y las cuentas nacionales, adoptado por Uruguay.

**SEN (Sistema Estadístico Nacional)**: Conjunto de organismos, metodologías y procesos que producen las estadísticas oficiales de Uruguay, coordinado por el INE (Ley 16.616/1994).
...
glosario administración pública Uruguay, términos gestión pública, AGESIC ONSC INE definiciones, carrera administrativa glosario, ECH IPC PIB definiciones, escalafón funcionario público, ente autónomo Uruguay, municipio Uruguay definición, RVE registro vínculos Estado, UAIP Uruguay, JUTEP Uruguay, SEN Uruguay definición, datos abiertos definición Uruguay
