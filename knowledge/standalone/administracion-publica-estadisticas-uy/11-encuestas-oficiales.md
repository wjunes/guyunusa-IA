# Encuestas oficiales de Uruguay
...
La **ECH** es la encuesta más importante del Sistema Estadístico Nacional. Se realiza de forma continua (mensual, con publicación trimestral y anual) desde 1968. Es realizada por el **INE**.

### Objetivo

Medir las condiciones de vida de la población uruguaya: empleo, ingresos, pobreza, acceso a servicios y características del hogar.

### Cobertura

- **Geográfica**: todo el territorio nacional.
- **Poblacional**: hogares y personas residentes en viviendas particulares.

### Muestra y metodología

- Muestra probabilística, estratificada, polietápica.
- Unidad de muestreo: vivienda → hogar → personas.
- Marco muestral: basado en el Censo de Población y Viviendas.
- Tamaño de muestra anual: aproximadamente 45.000–50.000 hogares.

### Variables e indicadores principales

| Variable | Indicador derivado |
|---|---|
| Actividad económica | Tasa de empleo, desempleo, actividad |
| Ingresos del hogar | Ingreso per cápita, distribución, Gini |
| Pobreza | Tasa de pobreza por ingreso; pobreza multidimensional |
| Educación | Asistencia escolar, nivel educativo alcanzado |
| Vivienda | Tenencia, materiales, hacinamiento, servicios básicos |
| Acceso a servicios | Agua, saneamiento, electricidad, internet |
| Características demográficas | Edad, sexo, composición del hogar, migrantes |

### Periodicidad y publicación

- **Mensual**: indicadores del mercado de trabajo (tasa de desempleo, empleo, actividad).
...
La **Encuesta de Actividad Industrial** es realizada por el **INE** con periodicidad mensual. Mide la evolución de la producción industrial en Uruguay.

### Variables principales

- Volumen físico de producción por sector (CIIU).
- Horas trabajadas en la industria.
- Personal ocupado en el sector industrial.
- Ventas industriales.
...
La **Encuesta de Construcción** (INE / MIEM) mide la actividad del sector construcción mediante:
- Índice Sintético de la Actividad de la Construcción (ISAC).
...
La **EGIH** es una encuesta periódica (no continua) que recoge información detallada sobre el **gasto de consumo de los hogares** uruguayos. Es la base para actualizar la **canasta del IPC** y para estudiar patrones de consumo.
...
El **MGAP** (a través de DIEA — Dirección de Estadísticas Agropecuarias) realiza encuestas sobre la actividad agropecuaria:
- **Encuesta de Actividad Agropecuaria Básica**: stock ganadero, superficie sembrada, producción.
- **Encuesta Agrícola**: producción de cultivos de secano y riego.
...
El INE publica los resultados de las encuestas en:
...
encuestas oficiales Uruguay, ECH Encuesta Continua Hogares, ECH INE Uruguay, tasa desempleo Uruguay ECH, pobreza Uruguay ECH, encuesta industria Uruguay, índice salarios IMS Uruguay, EGIH gasto hogares Uruguay, encuesta turismo Uruguay, encuesta agropecuaria MGAP DIEA, censos agropecuarios Uruguay, ENDIS Uruguay, ENAJ Uruguay, banco datos INE microdatos
