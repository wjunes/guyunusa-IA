# Historia de la Administración Pública uruguaya
...
En la segunda mitad del siglo XIX, el Estado uruguayo fue expandiendo sus funciones administrativas de manera gradual:

| Hito | Año | Significado |
|---|---|---|
| Constitución de 1830 | 1830 | Fundamento del Estado republicano |
| Creación de ministerios | 1829–1840 | Organización de la Administración Central |
| Ley de Educación Común (Varela) | 1877 | Educación pública laica, gratuita y obligatoria |
| Creación del Registro Civil | 1879 | Laicización del registro de personas |
| Registro de Estado Civil | 1885 | Separación Iglesia-Estado en actos vitales |
| Constitución de 1918 | 1918 | Ampliación de derechos; voto universal masculino |
...
- **Estatización de servicios públicos**: electricidad (UTE, 1912), seguros (BSE, 1911), banco (BROU, 1896 refundado en 1911).
- **Legislación laboral**: jornada de trabajo de 8 horas (1915), descanso semanal obligatorio, jubilaciones y pensiones.
- **Separación de la Iglesia del Estado**: consagrada en la Constitución de 1918.
- **Primer Estado de bienestar latinoamericano**: enseñanza pública ampliada, hospitales públicos, políticas sociales activas.
...
- **Constitución de 1934** y **Constitución de 1942**: ajustes institucionales; incorporación del Consejo Nacional de Gobierno (colegiado ejecutivo, 1952–1966).
...
La **Constitución de 1967** —vigente con modificaciones— es el marco institucional actual del Estado uruguayo. Introdujo cambios fundamentales:

- Retorno al Poder Ejecutivo unipersonal (Presidente de la República).
- Creación del **Banco Central del Uruguay (BCU)** (Ley 13.608/1967).
- Creación de la **Oficina de Planeamiento y Presupuesto (OPP)** como órgano asesor del Poder Ejecutivo.
...
- El Poder Ejecutivo concentró las funciones legislativas y ejecutivas.
- Miles de funcionarios públicos fueron destituidos por razones políticas o ideológicas (Ley 14.189/1974 y sucesivas).
...
Desde el retorno democrático, Uruguay impulsó sucesivas reformas de la Administración Pública:

### Reforma administrativa de los 90

En el marco de las reformas estructurales de la región, Uruguay adoptó medidas de racionalización del Estado:
- **Ley 16.320/1992 (Rendición de Cuentas)**: introdujo principios de gestión por resultados.
- **Privatizaciones parciales**: debate sobre empresas públicas; plebiscito de 1992 rechazó la privatización de ANTEL, OSE y otras.
- **Ley 16.736/1996**: reforma administrativa; creación de la **Comisión de Reforma del Estado**.

### Reforma tributaria y gestión (2000–2010)
...
- **AGESIC** (Agencia de Gobierno Electrónico y Sociedad de la Información y del Conocimiento) — Ley 17.930/2005.
- **Plan Ceibal** (2007): distribución de computadoras en escuelas públicas.
- **Expediente electrónico** (Decreto 276/013): digitalización de los procesos administrativos.
- **Firma electrónica** (Ley 18.600/2009): validez legal de la firma digital.
...
historia administración pública Uruguay, Estado uruguayo evolución, batllismo Estado bienestar, Constitución 1967 Uruguay, ONSC creación 1967, reforma Estado Uruguay, modernización administración pública, gobierno digital Uruguay, AGESIC Uruguay, servicio civil Uruguay historia, dictadura funcionarios públicos Uruguay, OPP Uruguay
