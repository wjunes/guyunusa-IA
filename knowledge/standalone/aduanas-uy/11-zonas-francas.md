...
- Las mercancías pueden ingresar, almacenarse, transformarse, fabricarse y reexportarse sin pagar los tributos que gravan el comercio exterior (DA, IVA en importación, IMESI).
...
Las empresas usuarias de zona franca gozan de:

- **Exoneración de todo tributo nacional**: IRAE, IVA, IP, IMEBA, IMESI y cualquier otro tributo nacional, presente o futuro, por las actividades desarrolladas dentro de la zona franca.
- **Exoneración de tributos sobre importación**: las mercancías que entran a la zona franca no pagan DA ni IVA de importación.
- **Sin retenciones sobre pagos al exterior**: los pagos a proveedores o socios en el exterior desde la zona franca están exonerados de las retenciones que normalmente aplican.
...
**Explotador de zona franca**: empresa pública o privada que obtiene la concesión del Estado para construir, desarrollar y administrar la infraestructura de la zona franca (galpones, oficinas, vías de acceso, servicios). El explotador también goza de exoneraciones tributarias por las actividades propias de la explotación.

**Usuario de zona franca**: empresa (nacional o extranjera) que instala sus operaciones dentro de la zona franca para realizar actividades habilitadas: industria, comercio, servicios, logística, almacenaje, financieros, tecnológicos, etc.
...
- **Industria**: fabricación y transformación de bienes para exportación.
- **Comercio**: almacenaje y distribución de mercancías para exportación o para venta a otras zonas francas o al exterior.
...
| Zona Franca | Ubicación | Explotador | Especialidad |
|---|---|---|---|
| Zona Franca de Montevideo (ZFM) | Montevideo (Ruta 1 km 21,5) | Zonamerica Uruguay S.A. | Servicios (TI, finanzas, logística, call centers) |
| Zona Franca WTC Free Zone | Montevideo (Torre 4 del WTC) | WTC Free Zone S.A. | Servicios (finanzas, TI, consultoría) |
| Zona Franca Colonia (ZFC) | Departamento de Colonia | Privado | Logística, almacenaje, industria |
| Zona Franca Rivera (ZFR) | Rivera | Privado | Comercio, almacenaje, zonas de frontera con Brasil |
| Zona Franca Libertad | San José | Privado | Industria, logística |
| Zona Franca Punta Pereira | Conchillas, Colonia | Katoen Natie/UPM | Logística forestal, exportación de celulosa |
| Zona Franca Nueva Palmira | Colonia | Privado | Logística portuaria, cereales |
| Zonas Francas del Interior (varias) | Interior del país | Privados | Industria y logística regional |
...
Las zonas francas han sido objeto de debate en Uruguay:
...
zonas francas Uruguay, Ley 15.921 zonas francas Uruguay, usuario zona franca Uruguay, explotador zona franca Uruguay, Zona Franca Montevideo Zonamerica, WTC Free Zone Uruguay, Zona Franca Rivera Uruguay, servicios exportables zona franca Uruguay, exoneraciones tributarias zona franca Uruguay, logística zona franca Uruguay, zona franca vs plaza Uruguay, Punta Pereira zona franca celulosa
