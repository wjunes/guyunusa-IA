# Regímenes aduaneros especiales en Uruguay

## Concepto de régimen aduanero especial
...
**Marco legal**: Ley 16.671 del 13 de diciembre de 1994, reglamentada por el Decreto 204/995.

**Modalidades**:

**Admisión temporaria con reexportación en el mismo estado (ATS)**: las mercancías ingresan, se utilizan y se reexportan sin ser transformadas. Ejemplos: equipos de filmación extranjeros para una producción en Uruguay; maquinaria de construcción temporal; animales para exhibición.

**Admisión temporaria para perfeccionamiento activo (APP)**: las mercancías ingresan para ser procesadas, transformadas o incorporadas en la fabricación de otros bienes, y el producto resultante es reexportado. Ejemplo: telas importadas para ser confeccionadas en Uruguay y exportadas como prendas.

**Garantía**: el beneficiario de la admisión temporaria debe constituir una garantía (depósito en efectivo, fianza bancaria, seguro de caución) equivalente a los tributos que correspondería pagar por la importación definitiva. La garantía se libera cuando se acredita la reexportación.
...
**Usos**:
- Equipos enviados al exterior para reparación, mantenimiento o calibración.
- Muestras enviadas para exposiciones o ferias.
- Bienes enviados para procesamiento (maquila inversa).
...
El depósito de aduana (también denominado depósito fiscal) es el régimen que permite almacenar mercancías extranjeras en recintos habilitados por la DNA, con suspensión del pago de los tributos de importación, hasta que se les asigne un destino aduanero definitivo (importación definitiva, reexportación, u otro régimen especial).

**Características**:
- Las mercancías en depósito no están en libre circulación en Uruguay.
- El operador del depósito fiscal es responsable de la custodia y la integridad de las mercancías.
- Se pueden realizar operaciones de mantenimiento, embalaje, reembalaje y clasificación dentro del depósito, pero no transformación industrial.
- El plazo de permanencia en depósito está sujeto a límites y puede prorrogarse.
...
**Tránsito internacional**: Uruguay es país de tránsito de mercancías destinadas a países sin litoral marítimo o que utilizan el Puerto de Montevideo como puerto de salida hacia terceros destinos (especialmente Paraguay, Bolivia y algunas regiones del Brasil). El tránsito internacional es una actividad importante para el Puerto de Montevideo y la logística regional.
...
regímenes aduaneros especiales Uruguay, admisión temporaria Uruguay Ley 16.671, exportación temporaria Uruguay, depósito fiscal aduana Uruguay, tránsito aduanero Uruguay, admisión temporaria perfeccionamiento activo Uruguay, drawback Uruguay, zona franca Uruguay régimen especial, equipaje viajeros Uruguay aduana, menaje casa Uruguay exoneración, garantía admisión temporaria Uruguay DNA, tránsito internacional Puerto Montevideo
