# Depósitos aduaneros y logística de comercio exterior en Uruguay

## El Puerto de Montevideo como hub logístico regional

El Puerto de Montevideo es el principal punto de entrada y salida de mercancías de Uruguay y un hub logístico de relevancia regional. Su posición geográfica en el Río de la Plata, su calado y su infraestructura lo convierten en un nodo importante para el comercio de Paraguay, Bolivia y partes del centro-oeste de Brasil y el norte de Argentina.
...
La DNA habilita depósitos aduaneros (depósitos fiscales) en distintas localizaciones del país para el almacenamiento de mercancías bajo control aduanero, con suspensión del pago de tributos. Los requisitos para la habilitación incluyen:

- Instalaciones adecuadas (seguridad, infraestructura, sistemas de inventario).
- Capacidad para rendir cuenta de las mercancías almacenadas.
- Personal habilitado y sistemas de registro.

Los depósitos aduaneros se dividen en:
...
**Terminal Granelera**: especializada en graneles sólidos (soja, celulosa, arroz, trigo). La exportación de soja (en grano y como harina/aceite) es uno de los principales flujos de la terminal granelera.

**Terminal de pasajeros y ferrys**: embarque y desembarque de pasajeros en los ferrys hacia Buenos Aires y Colonia. También opera tráfico de cruceros.
...
El transporte de mercancías entre el Puerto de Montevideo y el interior del país o los países vecinos se realiza principalmente por:

- **Camión**: el modo dominante para el transporte terrestre. La red vial uruguaya conecta el puerto con el interior y con los pasos de frontera.
...
La ANP es el ente autónomo estatal que administra los puertos de Uruguay, incluyendo Montevideo, Colonia, Fray Bentos, Paysandú, Salto, Nueva Palmira, Bella Unión, La Paloma y Punta del Este. Sus funciones incluyen:

- Gestión de la infraestructura portuaria (muelles, grúas, balizamiento).
- Otorgamiento de concesiones a terminales privadas.
- Control del acceso de buques a los puertos.
- Coordinación con la DNA para el control aduanero.
...
Puerto Montevideo logística, Puerto Libre Montevideo Ley 16.246, depósito aduanero Uruguay, depósito fiscal Uruguay DNA, ANP Administración Nacional Puertos Uruguay, TCP terminal contenedores Puerto Montevideo, zona actividad logística Uruguay, transporte multimodal Uruguay, ferry Montevideo Buenos Aires aduana, Aeropuerto Carrasco carga aérea Uruguay, ferrocarril UPM celulosa Uruguay, logística regional Uruguay hub
