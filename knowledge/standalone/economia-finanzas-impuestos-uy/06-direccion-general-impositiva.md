...
La **Dirección General Impositiva (DGI)** es el organismo del Estado uruguayo responsable de la administración del sistema tributario nacional. Depende orgánicamente del **Ministerio de Economía y Finanzas (MEF)**. Sus funciones principales son la recaudación, fiscalización y cobranza de los tributos nacionales que recaen sobre personas físicas, jurídicas y otras entidades.
...
Las competencias de la DGI incluyen:

- **Recaudación** de los tributos nacionales asignados por ley.
- **Fiscalización** de las declaraciones juradas de los contribuyentes.
- **Determinación** de obligaciones tributarias cuando corresponda.
- **Cobranza coactiva** de deudas tributarias en sede administrativa y judicial.
- **Atención al contribuyente**: información, asistencia, resolución de consultas vinculantes.
...
| Tributo | Descripción resumida |
|---|---|
| IVA | Impuesto al Valor Agregado (circulación de bienes y servicios) |
| IRPF | Impuesto a la Renta de las Personas Físicas |
| IRAE | Impuesto a las Rentas de las Actividades Económicas (25%) |
| IASS | Impuesto de Asistencia a la Seguridad Social |
| IMESI | Impuesto Específico Interno |
| Impuesto al Patrimonio | Sobre activos netos de personas y empresas |
| Impuesto de Primaria | Sobre inmuebles urbanos y suburbanos |
...
│   ├── Sector medianos contribuyentes
│   └── Sector contribuyentes de menor porte
├── División Cobranza Coactiva
├── División Servicios al Contribuyente
├── División Informática
├── División Jurídica
└── Dependencias regionales del interior
```
...
Uruguay implementó progresivamente el sistema de **factura electrónica** desde 2012. La e-factura permite la emisión, transmisión y almacenamiento de comprobantes fiscales en formato digital, con validación en tiempo real por la DGI. La adopción fue escalonada por tamaño de empresa, siendo obligatoria para la totalidad de los contribuyentes activos a partir de 2019.

Los beneficios del sistema incluyen:
- Mayor control de la evasión del IVA
...
Uruguay ha suscrito acuerdos de intercambio de información tributaria con numerosos países y participa en mecanismos multilaterales como el **AEOI (Automatic Exchange of Financial Account Information)** de la OCDE y el **Intercambio de Información bajo demanda** del Marco Inclusivo del BEPS.
...
DGI Dirección General Impositiva Uruguay, RUT Registro Único Tributario, e-factura factura electrónica Uruguay, tributos DGI Uruguay, Monotributo Uruguay, fiscalización tributaria Uruguay, cobranza coactiva DGI, consultas vinculantes DGI, IRPNF Uruguay, intercambio información fiscal Uruguay, AEOI OCDE Uruguay, reforma DGI Ley 17.706, administración tributaria Uruguay
