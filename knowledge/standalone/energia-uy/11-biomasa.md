# Biomasa como Fuente de Energía en Uruguay
...
| Tipo | Origen | Usos |
|------|--------|------|
| **Residuos forestales** | Corteza, ramas y aserrín de eucaliptos y pinos | Generación eléctrica en plantas de cogeneración |
| **Bagazo de caña de azúcar** | Residuo de la molienda de caña en Bella Unión (Artigas) | Cogeneración en la planta de ALUR |
| **Cáscara de arroz** | Residuo de la industria arrocera (Treinta y Tres, Rocha, Cerro Largo) | Generación eléctrica |
...
Uruguay tiene una extensa superficie de **plantaciones forestales** (principalmente eucaliptos y pinos) que se desarrollaron a partir de la **Ley Forestal N.º 15.939 de 1987** y su decreto reglamentario. Las plantas de **celulosa** (UPM en Fray Bentos y Conchillas, MUSA en Colonia) utilizan la madera como materia prima, pero el proceso genera grandes volúmenes de **residuos energéticos** (corteza, licor negro) que se usan para cogeneración.

### Cogeneración en plantas de celulosa

| Planta | Operador | Potencia de cogeneración (MW aprox.) |
|--------|---------|--------------------------------------|
| UPM Fray Bentos | UPM (Finlandia) | ~150 MW [VERIFICAR] |
| UPM Conchillas (UPM 2) | UPM (Finlandia) | ~270 MW [VERIFICAR] |
| MUSA | Stora Enso / Arauco | [VERIFICAR] |
...
| Parámetro | Valor |
|-----------|-------|
| **Empresa** | ALUR (filial ANCAP) |
| **Ubicación** | Bella Unión, departamento de Artigas |
...
El **biogás** se obtiene mediante la **digestión anaeróbica** de materia orgánica:
- **Efluentes de tambos y feedlots** (establecimientos ganaderos)
- **Rellenos sanitarios** (gas de vertedero / gas de landfill)
- **Efluentes de plantas de procesamiento de alimentos**
- **Lodos de plantas de tratamiento de aguas residuales**

### Biogás en rellenos sanitarios

El relleno sanitario de **Felipe Cardoso** (Montevideo) captura el biogás generado por la descomposición de los residuos sólidos urbanos y lo utiliza para generación eléctrica [VERIFICAR detalles de capacidad].

### Biogás en el sector agropecuario
...
- **Zonas rurales:** calefacción y cocción en estancias y pueblos pequeños
- **Industria:** hornos de ladrillo y cerámica, panaderías artesanales, secaderos de cereales
...
biomasa energía Uruguay cogeneración, residuos forestales eucaliptos Uruguay cogeneración UTE, bagazo caña azúcar ALUR Bella Unión biogás Uruguay, cáscara arroz generación eléctrica Uruguay, biogás Uruguay digestión anaeróbica, leña biomasa energía primaria Uruguay, plantas celulosa UPM Uruguay cogeneración excedentes electricidad, contratos PPA biomasa MIEM UTE Uruguay, energía renovable biomasa Uruguay porcentaje, biogás relleno sanitario Felipe Cardoso Montevideo
