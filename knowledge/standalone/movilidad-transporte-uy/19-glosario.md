# Glosario del dominio movilidad-transporte-uy

## A

**ADAS (Advanced Driver Assistance Systems)**: Sistemas electrónicos de asistencia a la conducción incorporados en vehículos modernos; incluyen frenado automático de emergencia, alerta de salida de carril y otras funciones preventivas.

**AFE (Administración de Ferrocarriles del Estado)**: Ente autónomo del Estado uruguayo creado por la Ley 11.907/1952, responsable de la gestión del sistema ferroviario nacional.

**ANP (Administración Nacional de Puertos)**: Ente autónomo del Estado uruguayo creado por la Ley 12.091/1954, responsable de la administración de los puertos públicos.
...
**CARU (Comisión Administradora del Río Uruguay)**: Organismo binacional Uruguay–Argentina que regula los usos del Río Uruguay, incluida la navegación.

**Central Uruguay Railway (CUR)**: Empresa ferroviaria de capital británico que construyó y operó las primeras líneas de ferrocarril en Uruguay (desde 1869) hasta la nacionalización de 1948.

**Ciclocarril**: Espacio en la vía pública destinado al tránsito de bicicletas, compartido con señalización horizontal, sin separación física.

**Ciclovía**: Infraestructura exclusiva para el tránsito de bicicletas, separada físicamente del tránsito vehicular.

**COETC**: Cooperativa de Obreros y Empleados de Transporte Colectivo; empresa operadora del STM de Montevideo.

**COPSA**: Cooperativa de Propietarios de Servicios de Autobuses; empresa operadora del STM.

**Corredor de cargas**: Ruta o secuencia de vías de transporte utilizada prioritariamente para el movimiento de cargas entre centros de producción y puertos o mercados.

**Corredor preferencial**: Carril o vía reservada para el tránsito exclusivo de vehículos de transporte colectivo (ómnibus), con el objetivo de mejorar su velocidad comercial.
...
**DNT (Dirección Nacional de Transporte)**: Dependencia del MTOP responsable de la habilitación y control del transporte terrestre de pasajeros y cargas.
...
**Integración tarifaria**: Sistema por el cual los transbordos entre líneas de transporte público se realizan con descuento o sin costo adicional dentro de un período determinado.

**Intercambiador**: Nodo físico donde convergen múltiples líneas de transporte colectivo, facilitando los transbordos entre servicios.

**IRI (International Roughness Index)**: Índice de regularidad superficial utilizado para medir el estado de los pavimentos viales; relevado periódicamente por la DNV.
...
**MERCOSUR**: Mercado Común del Sur, bloque regional integrado por Argentina, Brasil, Paraguay y Uruguay (y estados asociados), con normativa de transporte armonizada.

**Micromovilidad**: Modalidad de transporte individual de corta distancia con vehículos de pequeño porte y baja velocidad, como monopatines eléctricos y bicicletas eléctricas.

**Movilidad activa**: Modalidad de desplazamiento que implica esfuerzo físico por parte del usuario: caminata y ciclismo.
...
**PBC (Performance-Based Contract)**: Contrato de mantenimiento vial por niveles de servicio; el contratista es remunerado según el estado de la red que mantiene, no por obra ejecutada.

**PLUNA (Primeras Líneas Uruguayas de Navegación Aérea)**: Aerolínea de bandera de Uruguay, fundada en 1936 y liquidada en 2012.

**Puerto landlord**: Ver *Landlord model*.
...
**SIST (Sistema de Información sobre Siniestros de Tránsito)**: Base de datos de Uruguay administrada por UNASEV que registra los siniestros viales con información sobre circunstancias, víctimas y localización.

**Siniestro vial**: Denominación técnica para los eventos de tránsito que producen daños, lesiones o muertes; reemplaza al término "accidente" para reflejar su carácter prevenible.
...
**Tacógrafo**: Dispositivo instalado en vehículos de transporte profesional (pasajeros y carga) que registra los tiempos de conducción, descanso y velocidad del conductor.

**Tarjeta STM**: Instrumento de billetaje electrónico del Sistema de Transporte Metropolitano de Montevideo; permite integración tarifaria y tarifas diferenciadas por perfil de usuario.

**TCP (Terminal Cuenca del Plata)**: Principal terminal de contenedores del Puerto de Montevideo, operada por DP World bajo concesión de la ANP.

**Transbordo**: Cambio de un vehículo de transporte a otro en el marco de un mismo viaje.
...
glosario transporte Uruguay, términos transporte, definiciones movilidad Uruguay, AFE ANP DINACIA DNT DNV UNASEV STM, billetaje electrónico, tarjeta STM, Ferrocarril Central, GTFS datos abiertos, IRI pavimento, PBC contrato vial, SIST siniestros viales, TCP Puerto Montevideo, Hidrovía Paraguay-Paraná, CARU, OACI OMI MERCOSUR ATIT
