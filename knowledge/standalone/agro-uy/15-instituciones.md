# Instituciones del Sector Agropecuario Uruguayo
...
- **Sede:** Montevideo.
- **Función:** Organismo rector de las políticas agropecuarias del Estado uruguayo.
- **Principales unidades:**
  - **DIEA** (Dirección de Estadísticas Agropecuarias): censos y encuestas agropecuarias; datos de superficie, producción, precios, stock animal.
  - **DGDR** (Dirección General de Desarrollo Rural): políticas de desarrollo rural, colonización, género en el agro.
  - **DIGEGRA** (Dirección General de la Granja): horticultura, fruticultura, avicultura, porcicultura, apicultura.
  - **DSA** (División de Sanidad Animal): sanidad del rodeo; campañas de vacunación; aftosa, brucelosis, tuberculosis.
  - **DGSV** (Dirección General de Servicios Veterinarios): certificación sanitaria de exportaciones animales y productos.
  - **DGSSAA** (Dirección General de Servicios Agrícolas): sanidad vegetal; registro de plaguicidas y fertilizantes.
  - **DGF** (Dirección General Forestal): sector forestal.
...
- **Naturaleza jurídica:** persona jurídica de derecho público no estatal.
- **Sede:** Montevideo; 6 estaciones experimentales en todo el país.
- **Financiamiento:** 0,4% FOB exportaciones agropecuarias + presupuesto nacional.
...
- **Creación:** Ley 15.605 de **1984**.
- **Sede:** Montevideo.
- **Naturaleza:** Persona jurídica de derecho público no estatal.
- **Objetivos:**
  - Regular y controlar la faena de bovinos, ovinos, porcinos y otros animales de abasto.
  - Certificar las exportaciones cárnicas uruguayas.
  - Promover la carne uruguaya en los mercados internacionales.
  - Mantener estadísticas de producción, faena y comercio exterior de carnes.
...
- **Sede:** Montevideo.
- **Objetivos:**
  - Registrar y controlar la producción de uva y vino.
  - Promover la viticultura y la vinicultura uruguayas.
  - Certificar la calidad y origen de los vinos para exportación.
...
- **Creación:** Ley 18.242 de **2007**.
- **Sede:** Montevideo.
- **Naturaleza:** Persona jurídica de derecho público no estatal.
- **Objetivos:**
  - Monitorear y analizar el funcionamiento de la cadena láctea.
  - Elaborar estadísticas del sector lechero.
  - Promover la competitividad y el desarrollo sostenible de la lechería uruguaya.
...
- **Sede:** Montevideo.
- **Objetivos:**
  - Registrar variedades vegetales cultivadas en Uruguay.
  - Certificar la calidad de las semillas comercializadas.
  - Proteger los derechos del obtentor vegetal (protección de variedades).
  - Fiscalizar el mercado de semillas y controlar el uso de semillas de propiedad privada.
...
- **Naturaleza:** Persona jurídica de derecho público no estatal.
- **Sede:** Montevideo; extensionistas en todo el país.
- **Objetivo:** Extensión rural y transferencia de tecnología al productor agropecuario, con énfasis en medianos y pequeños productores.
- **Actividades:** cursos, jornadas técnicas, publicaciones, asesoramiento técnico, difusión de buenas prácticas.
...
- **Fundación:** 1871 (primera organización gremial agropecuaria del Uruguay).
- **Sede:** Montevideo.
- **Naturaleza:** Organización gremial privada de productores agropecuarios.
...
- **Fundación:** 1915.
- **Sede:** Montevideo.
- **Naturaleza:** Organización de segundo grado que agrupa a **Sociedades de Fomento Rural** (SFR).
...
MGAP Ministerio Ganadería Agricultura Pesca Uruguay, INIA investigación agropecuaria Uruguay Ley 16065 1989, INAC Instituto Nacional Carnes Uruguay faena exportación, INAVI Instituto Nacional Vitivinicultura Uruguay Ley 15876, INALE Instituto Nacional Leche Uruguay Ley 18242 2007, INASE Instituto Nacional Semillas Uruguay Ley 16811, Plan Agropecuario extensión rural Uruguay, Colonización Instituto Nacional Uruguay Ley 11029, ARU Asociación Rural Uruguay Expo Prado 1871, Federación Rural Uruguay CNFR Cooperativas Agrarias Federadas
