...
### Historia
- **1904:** Instalación de los primeros frigoríficos industriales de capitales extranjeros (principalmente British y norteamericanos) cerca de Montevideo y en Fray Bentos.
- **Frigorífico Anglo de Fray Bentos:** fundado como Liebig's Extract of Meat Company en **1863**; producía extracto de carne, corned beef y otros productos. Operó hasta **1979**. Declarado **Patrimonio Industrial de la Humanidad (UNESCO)** en **2015**.
- Expansión en el siglo XX: frigoríficos nacionales y extranjeros en Montevideo, Salto, Treinta y Tres y otras localidades.
- **2000–2023:** modernización; predominio de empresas nacionales (MARFRIG/Frigorífico Tacuarembó, JBS/Frigocerro, otros) y multinacionales.

### Proceso industrial
1. **Recepción y faena:** animales pesados, inspeccionados (MGAP-INAC), sacrificados y procesados en línea.
2. **Desposte:** separación de cortes (quartering + boning).
3. **Enfriado y congelado:** cadena de frío estricta para mercados de exportación.
4. **Empaque y etiquetado:** identificación con sistema SNIG y trazabilidad.
5. **Exportación:** por vía marítima (principal) y terrestre.

### Indicadores

| Indicador | Valor aproximado |
|-----------|-----------------|
| Número de frigoríficos habilitados | 30–50 establecimientos [VERIFICAR] |
| Faena anual | 2,0–2,5 millones bovinos + ~600.000 ovinos + cerdos |
| Exportaciones cárnicas totales | USD 1.500–2.000 millones/año |
| Principal mercado de carne | China (~50% del valor) |
...
- **CONAPROLE** es el actor dominante (~60-65% del mercado).
- Otras empresas: Calcar, Claldy, Ecolat, Lácteos del Uruguay, entre otras.
...
*(Ver también archivo 10-forestacion.md)*

| Empresa | Producto | Ubicación | Capacidad |
|---------|---------|-----------|-----------|
| UPM | Celulosa blanqueada | Fray Bentos (Río Negro) | ~1.000.000 t/año |
| Montes del Plata | Celulosa blanqueada | Conchillas (Colonia) | ~1.300.000 t/año |
| UPM 2 | Celulosa blanqueada | Paso de los Toros (Durazno) | ~2.100.000 t/año |
...
- Producción de vino tinto (predominante), blanco, rosado, espumoso.
- Exportaciones de vino: USD 15–30 millones/año.
...
- Producción de carne de pollo y huevos para consumo interno y exportación parcial.
- Empresas integradas (Cargill, Granja Moro, Prolesa y otros).
- Producción bajo sistemas semi-intensivos e intensivos.
- Uruguay es razonablemente autosuficiente en pollo y huevos.

### Porcicultura

- Producción de carne de cerdo para consumo interno (chacinería, embutidos) y exportación selectiva.
...
agroindustria Uruguay, industria frigorífica Uruguay faena bovina exportación carne, INAC Instituto Nacional Carnes Uruguay, CONAPROLE industria láctea exportaciones, industria arrocera molinos SAMAN COOPAR Uruguay, celulosa UPM Montes del Plata exportación Uruguay, industria vitivinícola bodegas INAVI Uruguay, molinería harina trigo aceite Uruguay, avicultura porcicultura Uruguay producción carne, trazabilidad carne natural Uruguay diferenciación mercados
