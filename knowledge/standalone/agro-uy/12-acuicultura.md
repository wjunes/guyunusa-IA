...
| Especie | Nombre común | Sistema productivo | Estado en Uruguay |
|---------|-------------|-------------------|------------------|
| *Ictalurus punctatus* | Bagre de canal | Estanques | Producciones comerciales menores |
| *Colossoma macropomum* | Pacú | Estanques; zonas cálidas (norte) | Incipiente |
| *Cyprinus carpio* | Carpa | Estanques y represas | Pequeña escala |
| *Onchorhynchus mykiss* | Trucha arcoíris | Agua fría; zonas serranas | Muy incipiente |

### Moluscos bivalvos (marino-costero)

| Especie | Nombre común | Sistema | Estado |
|---------|-------------|---------|--------|
| *Crassostrea gigas* | Ostión del Pacífico | Líneas en agua; fondos; Laguna Garzón, Maldonado | Producciones comerciales pequeñas |
| *Mytilus edulis platensis* | Mejillón rioplatense | Cuerdas; Río de la Plata | Experimental y pequeña escala |

### Crustáceos

- **Camarón rosado** (*Pleoticus muelleri*): cultivos experimentales.
- El camarón peneide de cultivo intensivo existe en pequeña escala.
...
|-----------|---------------|
| Producción total | <1.000 toneladas/año (muy baja comparada con producción pesquera) |
...
- **Río Uruguay:** pejerrey, dorado (*Salminus brasiliensis*), surubí, patí, boga, tararira.
- **Laguna Merín y tributarios:** variedades similares.
...
### Desafíos
- Falta de un marco regulatorio suficientemente ágil para el desarrollo empresarial.
- Competencia de importaciones (especialmente salmón de Chile y Argentina).
- Limitaciones de infraestructura portuaria y de procesamiento.
- Formación de recursos humanos especializados.

### Potencial
- Uruguay tiene costas atlánticas y del Río de la Plata con potencial para moluscos y peces marinos.
...
acuicultura Uruguay DINARA MGAP, pesca continental Uruguay ríos lagunas embalses, ostras mejillón Uruguay Laguna Garzón Maldonado, bagre canal pacú carpa acuicultura agua dulce Uruguay, Ley 19175 pesca acuicultura Uruguay, dorado surubí pejerrey Uruguay ríos, pesca deportiva Uruguay Río Uruguay Salto Grande, DINARA investigación acuicultura especies cultivadas
