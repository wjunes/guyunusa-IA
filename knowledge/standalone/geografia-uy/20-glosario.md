# Glosario de Geografía del Uruguay
...
**Acuífero Guaraní:** Sistema de acuífero transfronterizo de América del Sur, compartido por Argentina, Brasil, Paraguay y Uruguay. En Uruguay se extiende por el norte y centro del país (Artigas, Salto, Rivera, Tacuarembó). Sus aguas, de temperatura entre 30 y 50 °C, dan origen a los complejos termales del norte.

**AFE:** Administración de Ferrocarriles del Estado; organismo estatal a cargo de la red ferroviaria uruguaya (~2.900 km).

**ANP:** Administración Nacional de Puertos; administra los puertos uruguayos, principalmente el Puerto de Montevideo.
...
**CARU (Comisión Administradora del Río Uruguay):** Organismo binacional (Argentina-Uruguay) creado por el Estatuto del Río Uruguay (1975). Administra el uso del Río Uruguay.

**Cinturón Dom Feliciano:** Faja orogénica del Neoproterozoico (~600 Ma) que atraviesa el sureste de Uruguay y el sur de Brasil. Contexto geológico de las sierras y cerros más elevados del país.

**Cuchilla:** Divisoria de aguas característica del relieve uruguayo; cadena de colinas elongadas y suaves que separan cuencas hidrográficas. Las principales son la Cuchilla Grande (sureste) y la Cuchilla de Haedo (norte-noroeste).

**Cuchilla de Haedo:** Divisoria de aguas que recorre el norte y noroeste de Uruguay, separando la vertiente del Río Uruguay (oeste) de la del Río Negro (este). Altitudes de 200–380 m.
...
**DINAGUA:** Dirección Nacional de Aguas (Ministerio de Ambiente); rige la gestión de los recursos hídricos en Uruguay.

**DINABISE:** Dirección Nacional de Biodiversidad y Servicios Ecosistémicos (Ministerio de Ambiente); gestiona el SNAP y las políticas de biodiversidad.

**DINOT:** Dirección Nacional de Ordenamiento Territorial (MVOT); rector del ordenamiento territorial en Uruguay; aplica la LOTDS.
...
**Estuario del Río de la Plata:** Zona de transición entre el río y el mar, donde las aguas dulces del Río Uruguay y el Río Paraná se mezclan con las saladas del Océano Atlántico. Con ~320 km de longitud y hasta 220 km de ancho, es uno de los estuarios más grandes del mundo.
...
**Geomorfología:** Rama de la geografía física que estudia las formas del relieve y los procesos que las modelan. En Uruguay, los procesos dominantes son la erosión fluvial, la meteorización química y los procesos costeros.

**Geodesia:** Ciencia que estudia la forma, dimensiones y campo gravitacional de la Tierra; base de la cartografía precisa.
...
**IDEUY:** Infraestructura de Datos Espaciales del Uruguay; plataforma para compartir datos geoespaciales del Estado uruguayo. Decreto 399/007 (2007).

**IGM:** Instituto Geográfico Militar; organismo productor de cartografía oficial en Uruguay.

**INE:** Instituto Nacional de Estadística; produce los censos nacionales y estadísticas demográficas y económicas.
...
**Macrocefalia urbana:** Fenómeno de concentración desproporcionada de la población y las funciones económicas en la ciudad capital. En Uruguay, Montevideo concentra ~40% de la población y ~65–70% del PIB.

**Molisol:** Orden de suelos (taxonomía USDA) con horizonte A oscuro y rico en materia orgánica. Los más comunes en Uruguay (equivalen a los Brunizems). Alta fertilidad natural; aptos para ganadería y agricultura.

**MVOT:** Ministerio de Vivienda y Ordenamiento Territorial; rectoría de la política de vivienda y el ordenamiento territorial.
...
**Pampero:** Viento frío del suroeste que irrumpe periódicamente en Uruguay, produciendo descenso brusco de temperatura (10–20 °C en pocas horas). Característica meteorológica del Río de la Plata.

**Pastizal natural:** Ecosistema de gramíneas y herbáceas nativas que domina el paisaje uruguayo. Sustenta la ganadería extensiva y alberga biodiversidad única (aves, mamíferos, anfibios).
...
**Sierra:** Elevación de mayor relieve que las cuchillas, con laderas más pronunciadas. En Uruguay, las sierras más importantes son las de Aiguá (Maldonado), Carapé (Maldonado/Lavalleja) y Las Ánimas (Maldonado).

**SIRGAS 2000:** Sistema de Referencia Geocéntrico para las Américas, época 2000.0; datum geodésico oficial de Uruguay; compatible con WGS84.

**SNAP:** Sistema Nacional de Áreas Protegidas (Ley 17.234/2000); gestiona las áreas protegidas de Uruguay.

**SOHMA:** Servicio de Oceanografía, Hidrografía y Meteorología de la Armada; cartografía náutica y meteorología marina.
...
glosario geografía Uruguay términos, Acuífero Guaraní Uruguay definición, Cuchilla Grande Haedo Uruguay definición, SIRGAS 2000 datum geodésico Uruguay, Escudo Cristalino Uruguayo precámbrico definición, brunizem vertisol planosol suelos Uruguay, Embalse Bonete Baygorria Palmar Salto Grande definición, SNAP Ramsar humedales Uruguay definición, LOTDS Ley 18308 ordenamiento territorial Uruguay, macrocefalia urbana Montevideo Uruguay definición, ZEE Uruguay 200 millas náuticas, Pampero Sudestada fenómenos meteorológicos Uruguay
