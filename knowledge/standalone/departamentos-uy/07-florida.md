...
| Parámetro | Valor |
|-----------|-------|
| **Nombre oficial** | Departamento de Florida |
| **Capital** | Florida (ciudad) |
| **Superficie** | 10.417 km² |
| **Población** | 70.325 hab. (Censo 2023) |
| **Densidad** | 6,7 hab./km² |
| **Gentilicio** | Floridense |
| **Creación** | 3 de julio de 1837 |
| **Ubicación** | Centro-sur de Uruguay |
...
El departamento de Florida tiene un lugar especial en la historia uruguaya: el **25 de agosto de 1825**, en la ciudad de Florida, la Sala de Representantes de la Provincia Oriental declaró la **independencia de Uruguay** y su reintegración a las Provincias Unidas del Río de la Plata.

Este acontecimiento es conocido como la **Declaración de la Florida** y el **25 de agosto** es el **Día de la Independencia Nacional** de Uruguay. La ciudad de Florida guarda este patrimonio histórico con orgullo.
...
Terreno ondulado con cuchillas del sistema del Escudo Cristalino. Altitudes entre 50 y 200 m s.n.m. La Cuchilla Grande atraviesa el departamento de norte a sur como divisoria de aguas.

### Hidrografía

| Curso de agua | Descripción |
|--------------|-------------|
| **Río Santa Lucía** | Nace en el departamento de Florida (zona norte); fluye hacia el sur y sureste; fuente de agua potable de Montevideo |
| **Río Yi** | Afluente del Río Negro; nace en el norte del departamento |
| **Arroyo del Soldado** | Afluente interno |
...
Ganadería bovina y ovina extensiva, principal actividad económica.

### Agricultura

Soja, girasol, trigo. Tambos en la zona sur.
...
### El 25 de agosto en Florida

La ciudad de Florida celebra anualmente el **Día de la Independencia Nacional** (25 de agosto) con especial solemnidad, dado que allí se declaró la independencia en 1825.
...
|-----------|-------------|
| **Casa de la Independencia** | Museo histórico; sitio donde se firmó la declaración de 1825 |
...
| Institución | Descripción |
|-------------|-------------|
| **Intendencia de Florida** | Gobierno departamental |
...
|-----------|-------|--------|
| Superficie | 10.417 km² | INE |
| Población (Censo 2023) | 70.325 hab. | INE |
...
| Año | Hito |
|-----|------|
| 1809 | Fundación de la Villa de la Florida |
| 1825 | **25 de agosto**: Declaración de Independencia en la ciudad de Florida |
...
departamento Florida Uruguay, capital Florida ciudad, Declaración Independencia Uruguay 25 agosto 1825 Florida, Casa de la Independencia Florida Uruguay, Río Santa Lucía nace Florida, gentilicio floridense, ganadería Florida Uruguay, Intendencia Florida Uruguay, historia Uruguay independencia Florida
