...
Un fenómeno meteorológico se considera **severo** cuando supera umbrales de intensidad que generan riesgo para la vida, la infraestructura o las actividades económicas. INUMET define umbrales operativos de alerta para cada fenómeno. Los niveles de alerta son:

| Nivel | Color | Significado general |
|-------|-------|---------------------|
| 1 | Verde | Condiciones normales; sin alerta |
| 2 | Amarillo | Fenómeno posible; precaución |
| 3 | Naranja | Fenómeno probable con impacto significativo; advertencia |
| 4 | Rojo | Fenómeno muy severo; alerta máxima |
...
**Boyante de convección (CAPE — Convective Available Potential Energy):** Energía disponible para el ascenso convectivo. Umbrales de referencia para la evaluación de tormentas severas:

| Valor CAPE | Potencial convectivo |
|-----------|----------------------|
| 0–500 J/kg | Débil |
| 500–1.000 J/kg | Moderado |
...
**Ciclón extratropical (depresión extratropical):** Sistema de baja presión en latitudes medias (~30°–60° S). No es un ciclón tropical. Se desarrolla por el contraste de temperatura entre masas de aire polar y tropical (baroclinidad). Puede producir vientos de 80–120 km/h, precipitaciones intensas y grandes olas. Son los principales sistemas de tiempo severo en Uruguay.

**Convección profunda:** Ascenso violento de aire húmedo inestable hasta la tropopausa. Base de la formación de cumulonimbos, tormentas eléctricas, tornados y granizo.
...
**EF (Escala de Fujita Mejorada):** Escala de clasificación de la intensidad de un tornado basada en los daños producidos en estructuras. Va de EF-0 a EF-5.

| Categoría | Velocidad de viento estimada | Daños típicos |
|-----------|---------------------------|---------------|
| EF-0 | 105–137 km/h | Ligeros; ramas rotas; daños en techos |
| EF-1 | 138–177 km/h | Moderados; techos arrancados; árboles caídos |
| EF-2 | 178–217 km/h | Considerables; paredes destruidas; vehículos volcados |
| EF-3 | 218–265 km/h | Severos; pisos de casas demolidos |
| EF-4 | 266–322 km/h | Devastadores; casas demolidas hasta la fundación |
| EF-5 | > 322 km/h | Totalmente destructivos; estructuras sólidas arrasadas |
...
**Helada agronómica:** Temperatura del aire a 1,5 m igual o inferior a 0 °C que puede dañar o matar cultivos sensibles. Se distingue de la helada meteorológica (temperatura en caseta) y de la helada de superficie (temperatura a nivel del suelo, que puede ser varios grados inferior a la de caseta).

**Helada negra:** Helada sin formación de escarcha (el aire es demasiado seco para depositar hielo). Es más dañina para los cultivos que la helada blanca (con escarcha) porque el hielo depositado en la helada blanca puede proteger ligeramente los tejidos vegetales.

**Helada de advección:** Causada por el ingreso de una masa de aire frío. Afecta amplias zonas simultáneamente. Asociada al Pampero.
...
**Línea de inestabilidad (línea de turbonada / squall line):** Sistema organizado de tormentas convectivas alineadas, con frente de ráfagas en superficie, lluvia intensa y posibilidad de granizo y tornados. Puede extenderse cientos de kilómetros.

**LCL (Lifting Condensation Level):** Nivel de condensación por ascenso. Es la altura a la que una parcela de aire ascendente alcanza la saturación (100 % HR) y comienza a condensar. Base de la nube. LCL bajo (~500–800 m) favorece la formación de tornados.
...
**MCC (Mesoscale Convective Complex):** Tipo de MCS con forma casi circular en imágenes de satélite infrarrojo. Muy frecuentes en la región del Río de la Plata en primavera y verano.
...
**Pampero:** Viento del sur-suroeste que llega a Uruguay con el paso de frentes fríos. Es el fenómeno asociado a la entrada de aire polar continental (cPa). Características:

- **Dirección:** S–SO (180°–230°)
- **Velocidad media:** 30–60 km/h; rachas de hasta 80–100 km/h en episodios severos
- **Temperatura:** Descenso de 5–20 °C en pocas horas según la intensidad del frente
- **Visibilidad:** Buena; polvo en suspensión en algunas ocasiones
- **Duración:** 1–3 días en general
...
**Supercélula:** La forma más peligrosa de tormenta convectiva. Posee una mesociclón (rotación organizada en el interior de la tormenta) sostenido durante toda su vida. Puede producir granizo muy grande, ráfagas extremas, inundaciones localizadas y tornados violentos. Son posibles en Uruguay bajo condiciones de alta cortante vertical y gran inestabilidad, aunque menos frecuentes que en el centro de Estados Unidos.

**Squall line:** Ver *Línea de inestabilidad*.

**Storm surge (marea de tormenta):** Elevación anormal del nivel del mar o del Río de la Plata causada por vientos y baja presión atmosférica. La Sudestada produce el storm surge más importante en Uruguay: hasta +2 a +3 m sobre el nivel normal.

**Sudestada:** Viento del sureste que sopla con persistencia sobre el Río de la Plata. Características:

- **Dirección:** SE (110°–150°)
- **Velocidad:** 30–60 km/h; sostenido durante horas o días
- **Temperatura:** Fría y húmeda; tiempo lluvioso y gris
- **Nivel del Plata:** Elevación de +1 a +3 m sobre el nivel normal
- **Duración:** 1–5 días
...
**Tornado:** Columna de aire en rotación violenta que se extiende desde la base de un cumulonimbo hasta el suelo. Características en Uruguay:

- **Frecuencia:** Infrecuente (estimado en varios por año, pero la mayoría de baja intensidad y en zonas despobladas [VERIFICAR estadísticas de INUMET])
- **Temporada:** Primavera–verano; pico en setiembre–noviembre
- **Región más afectada:** Norte y centro del país
- **Duración:** Minutos a pocas decenas de minutos
- **Trayectoria:** Generalmente de NW a SE (siguiendo la dirección del sistema convectivo que lo genera)
- **Registro más grave:** Dolores (15/04/2016) — EF-2/EF-3
...
glosario fenómenos severos Uruguay definiciones técnicas, CAPE energía convectiva disponible Uruguay tormentas severas 1000 2500 J/kg, granizo severo Uruguay >2,5cm diámetro primavera norte centro septiembre noviembre, tornado Uruguay escala EF Fujita mejorada Dolores 2016 EF-2 EF-3, supercélula mesociclón Uruguay convección profunda cortante vertical, MCS MCC sistema convectivo mesoescala Río de la Plata primavera verano, Sudestada storm surge Uruguay +1-3m inundación costera Montevideo viento SE, Pampero viento sur suroeste frente frío Uruguay polar descenso temperatura, ola de calor Uruguay ≥3 días máxima ≥36°C mínima ≥22°C INUMET alerta, ciclogénesis extratropical Río de la Plata ciclogénesis explosiva bombs invierno, nowcasting Uruguay radar satélite alerta temprana 0-2 horas fenómenos severos, helada agronómica negra radiación advección Uruguay cultivos pasturas daño
