# Logística y competitividad exportadora de Uruguay

## La logística como factor de competitividad

La competitividad exportadora de Uruguay no depende solamente del precio y la calidad de sus bienes y servicios, sino también de la eficiencia de su sistema logístico: la capacidad de hacer llegar los productos a los mercados de destino en tiempo, forma y costo competitivos.
...
**Operadores**:
- **ANP (Administración Nacional de Puertos)**: ente público que administra el Puerto de Montevideo.
- **TCP (Terminal Cuenca del Plata)**: terminal de contenedores privada operada por Katoen Natie (empresa belga), que maneja la mayoría del tráfico de contenedores del puerto. La concesión de TCP fue un punto de controversia política y judicial en Uruguay durante el período 2020–2022.
- **Montecon**: terminal de contenedores alternativa al TCP, que operó en el Puerto de Montevideo hasta la resolución del conflicto con Katoen Natie/TCP.

**Servicios del Puerto de Montevideo**:
- Tráfico de contenedores (importación, exportación y tránsito).
- Granel sólido (soja, trigo, cebada) hacia mercados globales.
- Granel líquido (combustibles, aceites vegetales).
- Carga general.
- Pasajeros y cruceros.
- Terminal de cruceros (turismo).

El Puerto de Montevideo funciona como **hub logístico regional**: recibe cargas de los países vecinos (en particular Paraguay y Bolivia, países sin litoral marítimo) para reexportarlas al mundo.
...
La reactivación del **Ferrocarril Central** (tramo Montevideo–Paso de los Toros) fue la condición de infraestructura acordada entre Uruguay y UPM para la instalación de la planta UPM2 en Durazno.
...
El **transporte terrestre por camión** es el modo dominante de transporte de cargas en Uruguay (más del 90% de las cargas internas y una parte significativa del comercio con Brasil y Argentina).

Los principales corredores viales del comercio exterior son:
- **Ruta 1** (Montevideo-Colonia-Buenos Aires, via transbordador).
- **Ruta 3** y **Ruta 26** hacia los pasos de frontera con Brasil (Rivera-Livramento, Artigas-Quaraí, Bella Unión-Barra do Quaraí).
- **Ruta 8** hacia el paso de Aceguá-Aceguá.
- **Ruta 5** hacia Rivera.
- **Ruta 2** hacia Fray Bentos (paso Libertador San Martín con Argentina).
- **Ruta 3** hacia Paysandú (paso Ayuí con Argentina).
...
logística comercio exterior Uruguay, Puerto Montevideo ANP TCP Katoen Natie, Puerto Libre Montevideo Ley 16.246, Puerto Nueva Palmira hidrovía Paraguay Paraná soja Uruguay, Ferrocarril Central UPM2 AFE Uruguay, transporte cargas Uruguay camión rutas, Aeropuerto Internacional Carrasco carga aérea Uruguay, índice desempeño logístico LPI Banco Mundial Uruguay, competitividad exportadora Uruguay logística
