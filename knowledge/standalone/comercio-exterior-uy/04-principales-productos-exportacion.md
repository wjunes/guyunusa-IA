# Principales productos de exportación de Uruguay
...
- **UPM Fray Bentos** (ex Botnia): planta inaugurada en 2007 en el departamento de Río Negro, sobre el río Uruguay. Capacidad aproximada de 1,1 millones de toneladas anuales. Exporta principalmente a Europa (el conflicto con Argentina por la instalación de la planta derivó en el caso ante la Corte Internacional de Justicia, que falló en 2010 a favor de Uruguay).
- **Montes del Plata** (joint venture entre Arauco y Stora Enso): planta inaugurada en 2014 en Punta Pereira, departamento de Colonia. Capacidad aproximada de 1,3 millones de toneladas anuales. Es una de las plantas de celulosa más grandes de América del Sur.
- **UPM2 (UPM Paso de los Toros)**: tercera planta, inaugurada en 2023 en el departamento de Durazno. Capacidad de 2,1 millones de toneladas anuales. Requirió la construcción del Ferrocarril Central (rehabilitación de la línea Montevideo–Paso de los Toros) y la ampliación del puerto de Montevideo. UPM2 convirtió a Uruguay en uno de los principales productores de celulosa del mundo.
...
La carne bovina ha sido el principal rubro de exportación de Uruguay durante gran parte del siglo XX y XXI.

**Tipos de carne exportada**:
- Carne refrigerada de alta calidad (cuota Hilton a la Unión Europea — 6.300 toneladas anuales de cuota arancelaria preferencial).
- Carne congelada (mercados de menor exigencia de calidad: China, mercados árabes).
- Carne orgánica y con trazabilidad individual (SNIG — Sistema Nacional de Información Ganadera: Uruguay tiene trazabilidad bovina individual desde 2006).

**Principales mercados**: China (desde mediados de la década de 2010, se convirtió en el principal comprador de carne uruguaya), Unión Europea (cuota Hilton), Estados Unidos (acceso FSIS habilitado), Israel, Rusia (hasta 2022).
...
- Se exporta mayoritariamente como **grano** (soja sin procesar), con escaso procesamiento (harinas y aceite de soja tienen menor peso relativo en Uruguay en comparación con Argentina o Brasil).
- **Principales destinos**: China es el mercado dominante; también se exporta a países de la región y Europa.
...
Uruguay es el segundo exportador de lácteos de América del Sur (tras Argentina).

**Principales productos**:
- Leche en polvo entera (LPE) y descremada (LPD).
- Quesos: gouda, cheddar, muzzarella.
- Manteca y otros derivados.

**Conaprole** (Cooperativa Nacional de Productores de Leche) es el principal exportador, seguido de Calcar (LaCarlota), Claldy y otros.
...
- Produce arroz de alta calidad (tipo largo fino), competitivo en mercados de calidad media-alta.
...
La ganadería ovina uruguaya produce lana de alta calidad (lanas finas Merino y Corriedale).

- Se exporta como lana sucia (greasy), lana lavada, tops (peinada) y tejidos.
...
Las capturas pesqueras de Uruguay se exportan principalmente como:
- Filetes congelados de merluza (Merluccius hubbsi).
- Calamar (Illex argentinus) — captura en la Zona Económica Exclusiva.
- Langostino y otros mariscos.
...
principales productos exportación Uruguay, celulosa exportación Uruguay UPM Montes del Plata, carne bovina exportación Uruguay cuota Hilton INAC, soja exportación Uruguay China, concentrado bebidas zonas francas Uruguay, lácteos exportación Uruguay Conaprole, arroz exportación Uruguay, madera forestación exportación Uruguay, lana tops exportación Uruguay, medicamentos exportación Uruguay, merluza calamar exportación Uruguay
