# Destinos de las exportaciones uruguayas

## Evolución de los mercados de destino
...
**Rubros exportados a China**:
- Celulosa: los tres complejos celulósicos (UPM Fray Bentos, Montes del Plata, UPM2) destinan una proporción significativa de su producción a la industria papelera china.
- Carne bovina congelada: China otorgó habilitación a plantas frigoríficas uruguayas y se convirtió en el mayor comprador de carne bovina uruguaya.
- Soja: Uruguay exporta grano de soja a China dentro del flujo global de oleaginosas.
- Lácteos: China es un mercado de creciente importancia para la leche en polvo uruguaya.
...
- Arroz.
- Lácteos (Conaprole y otras empresas).
- Energía eléctrica (en períodos de excedente).
- Manufacturas diversas.
- Vehículos y autopartes (en el marco del ACE-2 ALADI).
...
**Rubros**:
- Carne bovina refrigerada de alta calidad (cuota Hilton: 6.300 toneladas anuales con arancel preferencial).
- Celulosa (Países Bajos, Alemania, Finlandia, Italia, Bélgica, Portugal son destinos relevantes para la celulosa de eucalipto).
- Lana (Italia y Alemania para la industria textil).
- Pescado (Unión Europea como destino para merluza y calamar).
...
Argentina es socio fundador del MERCOSUR y vecino de Uruguay. El comercio bilateral es intenso aunque sensible a la coyuntura macroeconómica y cambiaria argentina.

**Rubros**:
- Energía eléctrica (interconexión binacional, intercambios estacionales).
- Servicios (turistas argentinos son la principal corriente turística hacia Uruguay).
- Manufacturas diversas.
...
México, Colombia, Chile, Perú y Bolivia son destinos relevantes en el marco de los acuerdos del ALADI para:
- Arroz.
- Lácteos.
- Manufacturas.
...
destinos exportaciones Uruguay, China principal destino exportaciones Uruguay, Brasil exportaciones Uruguay MERCOSUR, Unión Europea exportaciones Uruguay cuota Hilton, Estados Unidos carne uruguaya FSIS USDA, Argentina comercio bilateral Uruguay, Oriente Medio carne halal Uruguay, acuerdo MERCOSUR-UE exportaciones Uruguay, diversificación mercados Uruguay XXI
