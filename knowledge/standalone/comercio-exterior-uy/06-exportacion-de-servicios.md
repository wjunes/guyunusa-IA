# Exportación de servicios de Uruguay

## Importancia de los servicios en el comercio exterior
...
- Los turistas argentinos constituyen la corriente más numerosa hacia Uruguay, concentrada en Punta del Este y Colonia del Sacramento.
- El turismo brasileño ocupa el segundo lugar.
- La temporada alta es diciembre-marzo (verano austral).
- Punta del Este (Maldonado) es el principal destino turístico de categoría internacional; Colonia del Sacramento (Patrimonio de la Humanidad UNESCO) atrae turistas de día desde Buenos Aires; Montevideo concentra turismo de negocios y cultural.
...
Uruguay tiene una industria de software y tecnologías de la información reconocida regionalmente y con proyección global.

**CUTI** (Cámara Uruguaya de Tecnologías de la Información) agremia a las empresas del sector y promueve sus exportaciones. Las exportaciones de software y servicios TI crecieron sostenidamente desde los años 2000.

**Características del sector**:
- Empresas de software uruguayas exportan productos y servicios a Estados Unidos, Europa, Brasil, Argentina y otros mercados.
- El sector se beneficia del **régimen de exoneración tributaria del software** (la Ley 17.243/2000 y modificaciones posteriores exoneran de IRAE a los ingresos por exportación de software).
- Las zonas francas, en particular **Zonamerica** (Montevideo), alojan empresas de servicios TI y BPO (Business Process Outsourcing) que operan desde Uruguay hacia mercados regionales y globales.
...
El Puerto de Montevideo funciona como nodo logístico del Cono Sur. La capacidad logística uruguaya genera exportaciones de servicios de:
- Almacenamiento y reexportación.
- Transporte internacional de cargas (camión, ferroviario, fluvial).
- Servicios de agencias marítimas.
- Puertos de la zona de actividades logísticas (ZAL) en el Puerto de Montevideo.
...
- Banca internacional (banca offshore, operaciones en dólares para no residentes).
- Gestión de activos.
- Servicios fiduciarios y de fideicomiso.
- Seguros para operaciones internacionales.
...
exportación servicios Uruguay, turismo receptivo Uruguay Punta del Este Colonia, software exportación Uruguay CUTI, tecnología información TI exportación Uruguay, centros servicios compartidos Uruguay Zonamerica, servicios logísticos portuarios Uruguay Puerto Montevideo, servicios financieros plaza uruguaya BCU, economía creativa audiovisual Uruguay, balanza servicios Uruguay BCU
