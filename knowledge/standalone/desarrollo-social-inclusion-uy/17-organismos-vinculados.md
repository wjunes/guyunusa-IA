# Organismos vinculados al desarrollo social en Uruguay

## Sistema interinstitucional de política social
...
**Ley de creación**: Ley 15.977/1988.
**Misión**: promover, proteger y hacer efectivos los derechos de los niños, niñas y adolescentes (NNA) en Uruguay.

**Principales funciones**:
- Administrar la red de Centros CAIF.
- Gestionar hogares de amparo para NNA sin cuidados parentales adecuados.
- Gestionar el sistema de adopciones.
- Supervisar a las organizaciones que trabajan con NNA.
- Coordinar el Sistema de Responsabilidad Penal Adolescente (con INISA).
...
**Dependencia**: MIDES.
**Creación**: 1990, reestructurado por Ley 18.216/2007.
...
**Dependencia**: MIDES.
**Ley de creación**: Ley 18.617/2009 (como INMAM, luego renombrado).
**Misión**: políticas públicas de envejecimiento activo y protección de personas mayores.
...
**Dependencia**: MIDES.
**Creación**: 2005.
**Misión**: políticas públicas de género e igualdad entre mujeres y hombres.
...
**Naturaleza**: ente autónomo del Estado.
**Misión**: gestionar la seguridad social contributiva en Uruguay.

**Vinculación con el desarrollo social**:
- Administra las AFAM-PE (pago de las asignaciones identificadas por el MIDES).
- Emite la Tarjeta Uruguay Social.
- Gestiona el Certificado Único de Discapacidad (CUD).
- Otorga la Pensión a la Vejez e Invalidez (prestaciones no contributivas).
- Administra el seguro de desempleo, enfermedad y maternidad.
...
**Misión**: prestación de servicios de salud pública a la población de Uruguay.

**Vinculación con el desarrollo social**:
- Atención de salud a personas en situación de vulnerabilidad (las más pobres acceden a ASSE gratuitamente a través del FONASA).
...
**Naturaleza**: ente autónomo del Estado.
**Misión**: administrar la educación pública en Uruguay.

**Vinculación con el desarrollo social**:
- Comedores escolares (CEIP).
- Educación de adultos.
- Educación especial para personas con discapacidad.
- Plan Ceibal (inclusión digital).
- Articulación con el MIDES en programas de revinculación educativa.
...
**Vinculación con el desarrollo social**:
- Empleo protegido y programas de primer empleo para jóvenes.
- Coordinación de Uruguay Trabaja.
...
**Vinculación con el desarrollo social**:
- Vivienda social para sectores de bajos ingresos.
...
**Misión**: coordinar las políticas de prevención, tratamiento y reducción de daños relacionados con el consumo de drogas.
...
organismos desarrollo social Uruguay, INAU INJU INMAYORES INMUJERES PRONADIS INDA Uruguay, BPS seguridad social Uruguay, ASSE salud pública Uruguay, ANEP educación pública Uruguay, MTSS empleo trabajo Uruguay, MVOT vivienda social Uruguay, INISA adolescentes infractores Uruguay, JND drogas Uruguay, CNPS coordinación políticas sociales Uruguay
